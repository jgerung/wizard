   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid334", tween: [ "style", "${_back}", "display", 'block', { fromValue: 'none'}], position: 8286, duration: 0 },
            { id: "eid336", tween: [ "style", "${_back}", "display", 'none', { fromValue: 'block'}], position: 10250, duration: 0 },
            { id: "eid332", tween: [ "style", "${_more2}", "display", 'block', { fromValue: 'block'}], position: 0, duration: 0 },
            { id: "eid333", tween: [ "style", "${_more2}", "display", 'none', { fromValue: 'block'}], position: 8286, duration: 0 },
            { id: "eid335", tween: [ "style", "${_more2}", "display", 'block', { fromValue: 'none'}], position: 9000, duration: 0 },
...
"intro1Text": {
   ...
   },
   {
      ...
      align: 'auto',
      id: 'Text4',
      text: 'By the time you’ve worked through all the bad mojo that fills “Phoenix,” you can’t but believe there’s a eulogy in Harry’s future. If David Chase can kill off Tony Soprano (and, yes, people, that’s what he did), what makes you think that J.K. Rowling is going to spare Potter, who might to be forced die to vanquish the evil from within and without.  “I feel so angry all the time,” Harry (Daniel Radcliffe) tells a confidante in “Phoenix.” “What if I’m becoming bad?”  Harry isn’t becoming bad — he’s just becoming a teen-ager. And in “Phoenix,” the fifth entry in Rowling’s seven-book series, we see the boy wizard turning into a sometimes sullen, almost always solitary, self-doubting figure.',
      rect: ['1','615','352','250','auto','auto'],
   ...
   },
   {
      ...
      id: 'potter_kiss',
      type: 'image',
      rect: ['0','446','329','161','auto','auto'],
      fill: ['rgba(0,0,0,0)','images/potter_kiss.jpg']
   },
   {
      transform: [],
      id: 'movie',
      type: 'image',
      rect: ['0','43','329','232','auto','auto'],
      fill: ['rgba(0,0,0,0)','images/movie.jpg']
   },
   {
      id: 'movie2',
      type: 'image',
      rect: ['0','0','119','43','auto','auto'],
      fill: ['rgba(0,0,0,0)','images/movie.png']
   }],
   symbolInstances: [
   ]
   },
