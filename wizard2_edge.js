   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid335", tween: [ "style", "${_back}", "display", 'none', { fromValue: 'block'}], position: 6243, duration: 0 },
            { id: "eid338", tween: [ "style", "${_back}", "display", 'block', { fromValue: 'none'}], position: 8286, duration: 0 },
            ...
            { id: "eid333", tween: [ "style", "${_more2}", "display", 'block', { fromValue: 'block'}], position: 0, duration: 0 },
            { id: "eid334", tween: [ "style", "${_more2}", "display", 'none', { fromValue: 'block'}], position: 8286, duration: 0 },
            { id: "eid336", tween: [ "style", "${_more2}", "display", 'block', { fromValue: 'none'}], position: 9002, duration: 0 },
...
"intro1Text": {
   ...
   dom: [
   {
      ...
      rect: [1,292,353,102],
      id: 'Text',
      text: 'As the Harry Potter series wraps up this summer, we can look back at two remarkable narratives: Potter the boy wizard and Potter the cultural phenomenon.Like “Star Wars” and “Star Trek,”  Potter the phenomenon is the story of how a work of popular art becomes a world of its own –  immortalized not by the marketers, but by the fans.',
   ...
   },
   {
      ...
      rect: [1,48,328,239],
      transform: [[0,0]],
      fill: ['rgba(0,0,0,0)','images/rowling.jpg']
   },
   {
      rect: [199,445,154,206],
      font: ['Arial, Helvetica, sans-serif',13,'rgba(0,0,0,1)','normal','none','normal'],
      align: 'auto',
      id: 'Text4',
      text: 'In the beginning, “Harry Potter” simply needed a home. Several British publishers turned down J.K. Rowling before the Bloomsbury Press signed her up in 1996, for $4,000 and a warning not to expect to get rich from writing children’s books. Bloomsbury suggested that Rowling use initials instead of her real name',
      transform: [[0,0]],
      type: 'text'
   },
   {
      ...
      align: 'auto',
      id: 'Text3',
      text: 'Joanne, out of fear that boys wouldn’t read a book by a woman.Rowling was  an unemployed, single English mother who gets the idea for a fantasy series while stuck on a train between Manchester and London.By 2000, Harry was a friend to millions, the toast of midnight book parties around the world. For a time, the first three Potter books held the top positions on the Times’ hardcover fiction list of best sellers, leading the newspaper to create a separate category for children’s books. The fourth work, “Harry Potter and the Goblet of Fire,” had a first printing of 3.8 million in the United States alone.',
   ...
   },
   {
      ...
      rect: [0,444,189,191],
      transform: [[0,0]],
      fill: ['rgba(0,0,0,0)','images/potterMidnight.jpg']
   },
   {
      id: 'potterPhenomenon',
      type: 'image',
      rect: [0,0,298,43],
      fill: ['rgba(0,0,0,0)','images/potterPhenomenon.png']
   }],
   symbolInstances: [
   ]
   },
