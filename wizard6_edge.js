   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid336", tween: [ "style", "${_more2}", "display", 'block', { fromValue: 'none'}], position: 9014, duration: 0 },
...
"intro1Text": {
   ...
   dom: [
   {
      ...
      rect: [1,289,330,104],
      id: 'Text',
      text: ' Mild-mannered British director David Yates had mostly worked in television and hadn’t even read one of J.K. Rowling’s books when he was asked to take the helm of the fifth film adaptation, “Harry Potter and the Order of the Phoenix.”',
   ...
   },
   {
      ...
      rect: [2,473,352,56],
      id: 'Text4',
      text: 'Q: There aren’t too many special effects on British TV shows. Was it hard to adjust to all of the film’s techno magic?',
      align: 'auto',
      transform: [[0,0]]
   },
   {
      ...
      rect: [2,521,352,104],
      id: 'Text4Copy3',
      text: 'A: It’s surprisingly easy to get your head around it, in truth. I had a lovely visual-effects supervisor called Tim Burke, and he’d say to me, “David, if you can think it, we can do it.” In my previous film (“The Tichborne Claimant”), I had one visual effect and this had 1,400, so it was quite a leap. But I enjoyed it. ',
      align: 'auto',
      transform: [[0,0]]
   },
   {
      ...
      rect: [2,620,352,24],
      id: 'Text4Copy5',
      text: 'Q: But no Quidditch in this one.',
      align: 'auto',
      transform: [[0,0]]
   },
   {
      ...
      rect: [2,638,352,81],
      id: 'Text4Copy4',
      text: 'A: Well, you know, Quidditch really didn’t feed the story that we wanted to tell, which is Harry’s journey, his struggle with himself and figuring out his place in the world. Quidditch would have sidelined that, in a way. But I think Quidditch is cool. We’ve probably got Quidditch in the next one.',
      align: 'auto',
      transform: [[0,0]]
   },
   {
      ...
      rect: [1,723,352,24],
      id: 'Text4Copy',
      text: 'Q: Is “Order of the Phoenix” too dark?',
      align: 'auto',
      transform: [[0,0]]
   },
   {
      ...
      rect: [1,742,352,81],
      id: 'Text4Copy2',
      text: 'A: The studio saw it and was really enthusiastic.  And the audiences I’ve seen it with have liked the darkness and intensity. They think it’s kind of cool.',
      align: 'auto',
      transform: [[0,0]]
   },
   {
      ...
      type: 'image',
      rect: [2,52,329,227],
      fill: ['rgba(0,0,0,0)','images/yates.jpg']
   },
   {
      id: 'magic',
      type: 'image',
      rect: [-1,0,176,43],
      fill: ['rgba(0,0,0,0)','images/magic.png']
   }],
   symbolInstances: [
   ]
   },
