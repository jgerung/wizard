   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid341", tween: [ "style", "${_back}", "display", 'block', { fromValue: 'none'}], position: 8286, duration: 0 },
            { id: "eid342", tween: [ "style", "${_back}", "display", 'none', { fromValue: 'block'}], position: 10250, duration: 0 },
            { id: "eid339", tween: [ "style", "${_more2}", "display", 'none', { fromValue: 'block'}], position: 8286, duration: 0 },
            { id: "eid340", tween: [ "style", "${_more2}", "display", 'block', { fromValue: 'none'}], position: 9000, duration: 0 },
...
"intro1Text": {
   ...
   dom: [
   {
      ...
      rect: [1,339,353,51],
      id: 'Text',
      text: 'Daniel Radcliffe reflects on his fifth and most mature outing as the troubled young sorcerer:',
   ...
   },
   {
      ...
      rect: [1,492,352,51],
      id: 'Text4',
      text: 'Q: You\'ve said \"Order of the Phoenix\" is your favorite Harry Potter book - and favorite movie so far. We suppose all the personal drama he gets is a big reason.',
      align: 'auto',
      transform: [[0,0]]
   },
   {
      ...
      rect: [1,541,356,67],
      id: 'Text2',
      text: 'A: As an actor it was great, because there\'s so much for Harry to do, which is always lovely. You always want more to work with.  All the emotions that Harry has to deal with in this film, it\'s just another way for me to move forward.',
      align: 'auto',
      transform: [[0,0]]
   },
   {
      ...
      rect: [1,606,356,51],
      id: 'Text3',
      text: 'Q: With the Ministry of Magic turned against him, Harry\'s in some dicey psychological places.',
      align: 'auto',
      transform: [[0,0]]
   },
   {
      ...
      rect: [1,641,352,67],
      id: 'Text5',
      text: 'A: If there was one album that could be Harry\'s soundtrack during this movie, I think it would be \"OK Computer\" by Radiohead. I think that tells you all you need to know about his character.',
      align: 'auto',
      transform: []
   },
   {
      ...
      rect: [1,704,352,42],
      id: 'Text6',
      text: 'Q: Assuming even you haven\'t gotten a look at \"The Deathly Hallows\" yet. What\'s your best guess of how it all ends up?',
      align: 'auto',
      transform: [[0,0]]
   },
   {
      ...
      rect: [1,741,352,67],
      id: 'Text7',
      text: 'A: Um, Harry lives, Voldemort dies, Snape is good? That\'s what I\'d like to think might happen, but I\'ve got no idea. But I wouldn\'t want it be as simple as Harry just living. There has to be another way of doing it.',
      align: 'auto',
      transform: [[0,0]]
   },
   {
      ...
      type: 'image',
      rect: [0,0,180,42],
      fill: ['rgba(0,0,0,0)','images/radcliffe.png']
   },
   {
      type: 'image',
      id: 'radcliffe2',
      rect: [0,42,329,293],
      transform: [[0,0]],
      fill: ['rgba(0,0,0,0)','images/radcliffe.jpg']
   }],
   symbolInstances: [
   ]
   },
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid332", tween: [ "style", "${_Text3}", "height", '42px', { fromValue: '42px'}], position: 6130, duration: 0, easing: "easeInQuad" }         ]
      }
   }
}
};
