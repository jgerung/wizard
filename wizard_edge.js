   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid333", tween: [ "style", "${_back}", "display", 'none', { fromValue: 'block'}], position: 6250, duration: 0 },
            { id: "eid336", tween: [ "style", "${_back}", "display", 'block', { fromValue: 'none'}], position: 8286, duration: 0 },
            { id: "eid335", tween: [ "style", "${_back}", "display", 'none', { fromValue: 'block'}], position: 10250, duration: 0 },
            ...
            { id: "eid331", tween: [ "style", "${_more2}", "display", 'block', { fromValue: 'block'}], position: 0, duration: 0 },
            { id: "eid332", tween: [ "style", "${_more2}", "display", 'none', { fromValue: 'block'}], position: 8286, duration: 0 },
            { id: "eid334", tween: [ "style", "${_more2}", "display", 'block', { fromValue: 'none'}], position: 9000, duration: 0 },
...
"intro1Text": {
   ...
   dom: [
   {
      type: 'image',
      id: 'intro1',
      rect: [167,108,188,282],
      transform: [[0,0]],
      fill: ['rgba(0,0,0,0)','images/intro1.jpg']
   },
   {
      type: 'image',
      id: 'intro2',
      rect: [177,450,179,280],
      transform: [[0,0]],
      fill: ['rgba(0,0,0,0)','images/intro2.jpg']
   },
   {
      rect: [1,112,153,282],
      ...
      align: 'auto',
      id: 'Text3',
      text: ' The Movie: Harry Potter (Daniel Radcliffe) returns to Hogwarts for one of his most difficult years yet. Not only must he study for his OWL (Ordinary Wizarding Levels) exams, but as the Ministry of Magic is gradually taking control of Hogwarts and spares no efforts trying to discredit him, he tries to tell the skeptical wizarding world the truth of Voldemort’s return.',
      transform: [],
      type: 'text'
   },
   {
      ...
      rect: [1,44,353,57],
      id: 'Text',
      text: '   On the occasion of  the release of the seventh and final volume of  J.K. Rowling’s fantasy epic and premiere of the fifth film adaptation, we take a look at the world of Harry Potter:',
   ...
   },
   {
      ...
      align: 'auto',
      id: 'Text4',
      text: 'The Book: In this final book of the series, Harry is burdened with a dark, dangerous and seemingly impossible task: locating and destroying Voldemort’s remaining Horcruxes (the seven divided portions of his soul placed in magical containers). The late Dumbledore believed that if that the Horcruxes could be destroyed, Voldemort would loose his invulnerability. Readers eagerly await the final showdown with Voldemort, finding out where Snape’s true loyalties lie and whether Harry will survive.',
      transform: [[0,0]],
      type: 'text'
   },
   {
      ...
      rect: [1,0,291,43],
      transform: [[0,0]],
      fill: ['rgba(0,0,0,0)','images/introHeader.png']
   }],
   symbolInstances: [
   ]
   },
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid329", tween: [ "style", "${_Text3}", "top", '117px', { fromValue: '117px'}], position: 6250, duration: 0 },
            { id: "eid289", tween: [ "style", "${_Text3}", "left", '0px', { fromValue: '0px'}], position: 6250, duration: 0, easing: "easeInQuad" },
            { id: "eid330", tween: [ "style", "${_Text3}", "font-weight", 'normal', { fromValue: 'normal'}], position: 8254, duration: 0 }         ]
      }
   }
}
};
